...
<head>
  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
    ...
    /* Profile header */
    .profile-header {
      background:#007B8F; color:#fff; padding:20px;
    ...
    .info-grid input, .info-grid select, .info-grid textarea {
      padding:8px; border:1px solid #ddd; border-radius:5px; background:#f9f9f9;
    }
    textarea { resize:none; }

    /* Botão */
    input[type="submit"], button[type="submit"] {
      background:#0ca4b9; color:#fff; padding:10px 20px;
      border:none; border-radius:5px; cursor:pointer;
      font-weight:500; transition:background 0.2s;
    }
    input[type="submit"]:hover, button[type="submit"]:hover { background:#0991a0; }
  </style>
</head>
<body>
  <!-- Sidebar -->
