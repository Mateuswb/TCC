    ...
    html: `
      <div style="text-align: left; font-size: 14px;">
        ...
        <ul style="margin: 8px 0 12px 20px; padding: 0;">
          <li style="font-size: 17px;">🗑️ Todos seus <strong>dados de profissional</strong> serão permanentemente excluídos.</li>
          <li style="font-size: 17px;">🚫 Sua conta será <strong> inativada </strong>, você não poderá reativar sem a permissão de um admin.</li>
